...
<head>
  ...
  <title><?= @$this->config->item('application_name'); ?> | Starter</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b><?= @$this->config->item('application_name'); ?></b>APP</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">Mwanalimu Navigation</li>
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          <a href="<?= @base_url('Courses/Units'); ?>">
            <i class="fa fa-graduation-cap"></i> <span>Units</span>
          </a>
        </li>
        <li><a href="<?= @base_url('Student'); ?>"><i class="fa fa-users"></i> <span>Students</span></a></li>
        <li class="treeview">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="#">Mwanalimu</a>.</strong> All rights reserved.
  </footer>
